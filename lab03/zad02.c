...
int main()
{
  short wynik;
  int wynik2;
  wynik = SHRT_MAX + 10; //32767+10 w teorii = 32777
  printf("SHORT  %i + 10 = %i\n",SHRT_MAX, wynik);//Ale jednak NIEEEE PRZYPADEK ?
  ...
  long double wynik7;
  wynik7 = 0.00000000000000005/4.0;
  printf("LONG DOUBLE 0.00000000000000005/4.0 = %Lf\n", wynik7);//LDBL_MIN =0.000000
  return 0;
}
